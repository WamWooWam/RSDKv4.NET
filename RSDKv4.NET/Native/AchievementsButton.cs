...
public class AchievementsButton : MenuButton
{
    public override void Create()
    {
        ...
        this.mesh = Renderer.LoadMesh("Data/Game/Models/Achievements.bin", texture);
        this.x = 0.0f;
        this.y = 16.0f;
        this.z = 160.0f;
        this.r = 0xFF;
        ...
        this.label.text = Font.GetCharactersForString(Strings.strAchievements, FONT.HEADING);
