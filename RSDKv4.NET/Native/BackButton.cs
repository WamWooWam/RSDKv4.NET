...
public class BackButton : NativeEntity
{
    ...
    {
        textureCircle = Renderer.LoadTexture("Data/Game/Menu/Circle.png", TEXFMT.RGBA4444);

        int texture = Renderer.LoadTexture("Data/Game/Menu/Intro.png", TEXFMT.RGBA4444);
        meshBack = Renderer.LoadMesh("Data/Game/Models/BackArrow.bin", texture);
        x = 0.0f;
        y = 16.0f;
        z = 160.0f;
        r = 0xFF;
    ...
    public override void Main()
    {
        if (this.visible)
        {
            ...
            Renderer.RenderMesh(this.meshBack, MESH.NORMALS, true);
