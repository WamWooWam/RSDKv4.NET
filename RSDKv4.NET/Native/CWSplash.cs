...
public class CWSplash : NativeEntity
{
    ...
    public override void Create()
    {
        ...
        this.textureId = Renderer.LoadTexture("Data/Game/Menu/CWLogo.png", TEXFMT.RGBA8888);
    }
    ...
    public override void Main()
    {
        switch (this.state)
        {
            case STATE.ENTER:
                ...
                Renderer.RenderRect(-SCREEN_CENTERX_F, SCREEN_CENTERY_F, 160.0f, SCREEN_XSIZE_F, SCREEN_YSIZE_F, 0xFF, 0x90, 0x00, 0xFF);
                Renderer.SetRenderBlendMode(RENDER_BLEND.ALPHA);
                Renderer.RenderImage(0.0f, 0.0f, 160.0f, 0.25f, 0.25f, 512.0f, 256.0f, 1024.0f, 512.0f, 0.0f, 0.0f, 255, (byte)this.textureId);
