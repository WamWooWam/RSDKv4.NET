...
public class MenuControl : NativeEntity
{
    public enum STATE
    {
        MAIN, ACTION, NONE, ENTERSUBMENU, SUBMENU, EXITSUBMENU, DIALOGWAIT
    }

    public enum STATEINPUT
    {
        CHECKTOUCH, HANDLEDRAG, HANDLEMOVEMENT, MOVE, HANDLERELEASE
    }

    public enum BUTTON
    {
        STARTGAME = 1, TIMEATTACK, MULTIPLAYER, ACHIEVEMENTS, LEADERBOARDS, OPTIONS
    }
